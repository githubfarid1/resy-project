...
class ResyBotBookingFrame(ttk.Frame):
	...
	def getData(self, event):
		try:
			...
			self.timeentry.set12Hrs(self.chosenRow[6].split(":")[0] )
			self.timeentry.setMins(self.chosenRow[6].split(":")[1].split(" ")[0])
			self.timeentry.setPeriod(self.chosenRow[6][-2:].lower()[0] + "." + self.chosenRow[6][-2:].lower()[1])
